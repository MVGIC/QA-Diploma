...
1) Покупка тура по дебетовой карте (валидная карта - "4444 4444 4444 4441", approved):
...
- 
2) Покупка тура по дебетовой карте (невалидная карта - "4444 4444 4444 4442", declined):
- 
